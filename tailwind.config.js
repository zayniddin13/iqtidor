...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        primaryBlue: "#23415D",
        secondaryBlue: "#244360",
        "yellow-in-light": "#FDB807",
        "main-grey": "#E2E7EB",
        "grey-2": "#BEBEBE",
        "grey-3": "#696871",
        "grey-4": "#DEDEDE",
    ...
    boxShadow: {
      ...
      md: "0px 4px 10px 0px rgba(0, 0, 0, 0.08), 0px 0.5px 2px 0px rgba(0, 0, 0, 0.20)",
      lg: "0px 10px 16px 0px rgba(75, 75, 75, 0.25)",
      xl: "0px 5px 15px 0px rgba(133, 171, 206, 0.11)",
