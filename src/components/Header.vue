<template>
  <div class="relative z-10">
    ...
    <div class="w-full border-b border-b-main-grey">
      <div
        class="max-[820px]:hidden px-5 max-w-[1300px] mx-auto py-7 flex items-center justify-between"
      >
        ...
        <div class="nav-right flex items-center gap-6 max-[1080px]:gap-2">
          <router-link
            to="/about-page"
            class="group text-base font-bold text-secondaryBlue leading-5 transition-all duration-300 cursor-pointer"
          >
            {{ t("navbar.about") }}
            <div
